...
function onStart()
    ...
    --rttr.AIConstructionOrder(1,69,119,BLD_WATCHTOWER)
    --rttr.AIConstructionOrder(1,70,118,BLD_WATCHTOWER)
    --rttr.AIConstructionOrder(1,87,110,BLD_FORTRESS)
    --rttr.AIConstructionOrder(1,84,116,BLD_FORTRESS)
    --rttr.AIConstructionOrder(1,89,122,BLD_FORTRESS)
    rttr.AIConstructionOrder(1,47,100,BLD_FORTRESS)
    rttr.AIConstructionOrder(1,39,102,BLD_FORTRESS)
    --rttr.AIConstructionOrder(1,77,113,GUARDHOUSE)
    ...
    --rttr.DisableBuilding(1,BLD_BARRACKS,BLD_GUARDHOUSE,BLD_CATAPULT,BLD_SHIPYARD,BLD_HARBORBUILDING)
    rttr.DisableBuilding(1,BLD_CATAPULT,BLD_SHIPYARD,BLD_HARBORBUILDING)
...
function onOccupied(p,x,y)
    ...
    if(x==32 and y==35 and chat4_m==0) then
        rttr.Chat(0,chat4)
        chat4_m=1
        frame1_c=((rttr.GetGF()%20)*20)+1000
